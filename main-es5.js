(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                ...
                HomeComponent.prototype.validarData = function () {
                    // tslint:disable-next-line: max-line-length
                    var patternData = /^(?:(?:31(\/|-|\.)(?:0?[13578]|1[02]))\1|(?:(?:29|30)(\/|-|\.)(?:0?[1,3-9]|1[0-2])\2))(?:(?:1[6-9]|[2-9]\d)?\d{2})$|^(?:29(\/|-|\.)(?:0?2)\3(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\d|2[0-8])(\/|-|\.)(?:(?:0?[1-9])|(?:1[0-2]))\4(?:(?:1[6-9]|[2-9]\d)?\d{2})$/;
                    var data = this.form.controls.data.value;
                    var dataFormatada = data.toLocaleDateString('pt');
                    return patternData.test(dataFormatada);
                };
                HomeComponent.prototype.mostrarInputDados = function () {
                    return this.form.controls.status.value === true;
                };
                HomeComponent.prototype.apresentarDados = function () {
                ...
                HomeComponent.prototype.iniciarForm = function () {
